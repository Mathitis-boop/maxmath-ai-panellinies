      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-6">
          ...
          <div className="grid lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
            {[
              {
                quote: "Σε 2 εβδομάδες κατάλαβα περισσότερα από όλο το τετράμηνο στο φροντιστήριο. Το AI με οδήγησε ακριβώς εκεί που χρειαζόμουν βοήθεια.",
                name: "Μαρία Κ.",
                grade: "Γ' Λυκείου",
                avatar: "Μ",
                color: "from-blue-500 to-blue-600",
              ...
              {
                quote: "Πρώτη φορά που αισθάνομαι σίγουρος για τα Μαθηματικά. Η πλατφόρμα με έκανε να αγαπήσω το μάθημα!",
                name: "Νίκος Π.", 
                grade: "Γ' Λυκείου",
                avatar: "Ν",
                color: "from-emerald-500 to-emerald-600",
          ...
          <div className="border-t border-gray-800 pt-8 animate-[fadeInUp_1s_ease-out_0.6s_both]">
            <div className="text-center">
              ...
              <p className="text-gray-500 text-sm">
                © 2025 MaxMath. Όλα τα δικαιώματα προστατεύονται.
              </p>
            </div>
          </div>
        </div>
